...
<body>
	...
	<div class="container">
		...
		<form:form action="s_user" method="post" modelAttribute="e_user" enctype="multipart/form-data">
			...
			<c:choose>
				<c:when test="${empty e_user.userphoto}">
					<img src="images/user_icon.jpg" alt="User Profile"  width="300px">
				</c:when>
				<c:otherwise>
					<img src="/images/${e_user.userphoto}" alt="User Profile" width="300px">
