package com.summative_project.SpringBoot_CarSale;
...
import com.summative_project.SpringBoot_CarSale.service.UserDetailsServiceImpl;
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET,"/user_delete").hasRole("Administrator")
